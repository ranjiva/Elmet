...
<a name="product"></a>
<p class="sublink"><a HREF="/offers">Back to Curtain Offers</a></p>
...
<p>Click on design pattern for close-up</p>
	...
	<div id="colours">
		...
		<table><tr style="vertical-align:top">
                   <?php
                    foreach ($curtainDesign->getCurtainColoursOnOffer() as $colour) {
                        
                        echo "<td><p><strong>".$colour->getName()."</strong></p>";
                        echo "<a href=\"/offers/select/".$curtainDesign->getUrlName()."/".$colour->getName()."\">";
