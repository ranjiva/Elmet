...
<?php $view['slots']->set('title', 'Customer Services - Delivery Information') ?>

<h1>Delivery Information</h1>

<ul>
    <li>Elmet Curtains will dispatch orders within 7 working days from receipt of the order along with full payment.</li>
