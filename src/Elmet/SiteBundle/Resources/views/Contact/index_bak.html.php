...
<title>Contact Elmet Curtains</title>
...
<div id="contact-form">
  ...
  <div class="input text"><label for="ContactCustomerName">Name</label><input name="data[Contact][customer_name]" type="text" size="25" maxlength="50" value="" id="ContactCustomerName" /></div>

  <div class="input text"><label for="ContactCustomerTel">Tel</label><input name="data[Contact][customer_tel]" type="text" size="25" maxlength="20" value="" id="ContactCustomerTel" /></div>  <div class="input text"><label for="ContactCustomerEmail">Email</label><input name="data[Contact][customer_email]" type="text" size="50" maxlength="50" value="" id="ContactCustomerEmail" /></div>  <div class="input textarea"><label for="ContactEnquiry">Enquiry</label><textarea name="data[Contact][enquiry]" cols="50" rows="10" id="ContactEnquiry" ></textarea></div>
  <div class="submit"><input type="submit" name="Send" value="Send" /></div>  </form>
</div>
